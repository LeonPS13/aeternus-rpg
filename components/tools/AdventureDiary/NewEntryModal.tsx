      ...
      <div className="arcane-panel animate-[fade-up_0.25s_ease-out_forwards] w-full max-w-lg shadow-2xl">
        ...
        <div className="flex items-center justify-between px-6 py-4"
          ...
          <div>
            ...
            <p className="text-sm" style={{ color: 'var(--color-text-muted)' }}>{tabLabel}</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 px-6 py-5">
          <div className="flex flex-col gap-3 sm:flex-row">
            <div className="w-full sm:w-36 sm:shrink-0">
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 text-base [color-scheme:dark]"
                style={inputStyle}
              />
            </div>
            <div className="flex-1">
              <label className="mb-1.5 block text-sm font-medium" style={{ color: 'var(--color-text-muted)' }}>Título</label>
              <input
                value={title}
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium" style={{ color: 'var(--color-text-muted)' }}>Resumo da Sessão</label>
            <textarea
              value={summary}
          ...
          <div>
            <label className="mb-1.5 block text-sm font-medium" style={{ color: 'var(--color-text-muted)' }}>Tags</label>
          ...
          <div className="flex justify-end gap-2 pt-1">
            ...
            <button type="submit" disabled={!title.trim() || !summary.trim()}
              className="arcane-btn px-5 py-2 text-base font-semibold">
